...
const categories = [
    { id: 'ufh', name: 'Underfloor Heating', icon: '&#128168;', desc: 'Water or electric systems' },
    { id: 'boiler', name: 'Boiler Replacement', icon: '&#128293;', desc: 'Combi, System or Conventional' },
    { id: 'ashp', name: 'Air Source Heat Pump', icon: '&#127811;', desc: 'Renewable heating' },
    { id: 'bathroom', name: 'Bathroom Installation', icon: '&#128705;', desc: 'Full refits & wet rooms' },
    { id: 'radiator', name: 'Radiator Install', icon: '&#127777;', desc: 'New or replacement radiators' },
    { id: 'cylinder', name: 'Cylinder Install', icon: '&#128167;', desc: 'Unvented or vented systems' },
    { id: 'extension', name: 'Plumbing for Extension', icon: '&#127968;', desc: 'New build or extensions' },
    { id: 'softener', name: 'Water Softener', icon: '&#128166;', desc: 'Hard water solutions' },
    { id: 'repipe', name: 'Whole House Repipe', icon: '&#128295;', desc: 'Complete pipework replacement' }
];
